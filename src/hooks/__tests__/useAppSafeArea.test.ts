...
describe('useAppSafeArea', () => {
  test('when the safe area is less than the minimum requirement, returns the minimum requirement', () => {
  ...
  test('when the safe area is greater than the minimum requirement, returns the safe area', () => {
    mockedUseSafeAreaInsets.mockImplementationOnce(
